...
public class Office365ContactService {
  ...
  public void manageDefaultContactFolder(
    ...
    if (contactFolder == null) {
      contactFolder =
          contactFolderRepo.findByName(I18n.get(ITranslation.OFFICE_CONTACT_DEFAULT_FOLDER));
    ...
    office365Service.syncContacts(
        officeAccount, accessToken, officeId, contactFolder, removedContactIdList);
  }
  ...
  public void setPartnerValues(
    ...
    if (contactFolder != null) {
      ...
      contactFolder =
          contactFolderRepo.findByName(I18n.get(ITranslation.OFFICE_CONTACT_DEFAULT_FOLDER));
      if (contactFolder != null) {
        if (StringUtils.isBlank(contactFolder.getOffice365Id())) {
          contactFolder.setOffice365Id(
              office365Service.processJsonValue("parentFolderId", jsonObject));
        }
        partner.setContactFolder(contactFolder);
      }
